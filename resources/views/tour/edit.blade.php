<x-layout title="Modifica Tour">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8">
            ...
            <form class="reg-log-form p-3 text-dark" method="POST" action="{{ route('tour.update', compact('tour')) }}"
                ...
                <div class="mb-3">
                    ...
                    <img src="{{ Storage::url($tour->img) }}" class="tour-show-img-edit"
                        alt="Immagine di {{ $tour->name }}">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="tags[]"
                                    ...
                                    @if ($tour->tags->contains($tag)) checked @endif>
